...
🔗 View my resume: https://ferhattufekci.github.io/#resume

<h2 align="center">🧰 Tech Stack & Tools</h2>

#### 🧑‍💻 Methodologies & Process Models

`SDLC` `AI-Driven SDLC` `Scrum` `CMMI-5` `INCOSE` `MBSE` `BABOK ` `ISTQB` `TDD` `ATDD` `BDD`
...
`Spec-Driven Development with AI Agents` `Java` `Spring Framework` `Spring Boot` `Apache Velocity` `Java Swing` `JavaFX` `Hibernate` `JUnit` `Anaconda` `Python` `Pandas` `Numpy` `PHP` ` Laravel` `C` `C++` `C#` `LINQ` `ASP.NET` `ASP.NET MVC` `.NET Core` `.Entity Framework Core (EF Core)`

#### 🌐 Frontend Technologies

`HTML` `CSS` `JavaScript` `Bootstrap` `PrimeFaces` `JSF` `React.js` `Figma` `Photoshop`
...
- [The Advantage: Why Organizational Health Trumps Everything Else In Business (J-B Lencioni Series)](https://www.goodreads.com/review/show/8799614323?utm_medium=api&utm_source=rss) by Patrick Lencioni. Average Rating: 4.11
- [The Five Dysfunctions of a Team](https://www.goodreads.com/review/show/8799613324?utm_medium=api&utm_source=rss) by Patrick Lencioni. Average Rating: 4.09
...
- [Spring Start Here: Learn what you need and learn it well](https://www.goodreads.com/review/show/7921751177?utm_medium=api&utm_source=rss) by Laurentiu Spilca. My Rating/Average Rating: 5/4.61
...
- [The Lean Startup: By Eric Ries – Summary Of The Key Ideas In 30 Minutes Or Less](https://www.goodreads.com/review/show/7837693548?utm_medium=api&utm_source=rss) by Jordan Baker. My Rating/Average Rating: 0/4.14
